...
const COMMANDS: Record<string, string> = {
  ...
  whoami: `Dylan Butelho\nSoftware Engineer · M.S. CS @ Syracuse (May 2026)\nAI agents · Full-stack · Backend · Cloud\n${profile.location}`,
  skills:
    "+----------------------+----------------------------------------------+\n| Area                 | Technologies                                 |\n+----------------------+----------------------------------------------+\n| AI Agents & LLMs     | LangGraph, LangChain, RAG, MCP, OpenAI       |\n| ML & Training        | PyTorch, TensorFlow, HF, SFT/PPO/DPO/GRPO    |\n| Languages & APIs     | Python, JS/TS, Java, Go, C/C++, SQL, REST    |\n| Full Stack           | React, Node, Express, FastAPI, Flask, Django |\n| Infrastructure       | AWS, GCP, Docker, K8s, Terraform, CI/CD      |\n| Observability        | Prometheus, Grafana, Datadog, OpenTelemetry  |\n+----------------------+----------------------------------------------+",
  status:
    "  [ACTIVE] Software Engineer @ iConsult Collaborative (Syracuse, NY)\n  [ACTIVE] M.S. Computer Science @ Syracuse University (May 2026)\n  [BUILD]  OrangeBot · H1B JobPilot · LLM Alignment Lab\n  [OPEN]   U.S. roles · Open to relocation",
  projects:
    "  01  OrangeBot\n      Multi-agent AI system with LangGraph, RAG, MCP, FastAPI, React\n\n  02  H1B JobPilot (in progress)\n      AI career platform with LangChain, USCIS/DOL data, FastAPI, AWS\n\n  03  LLM Alignment Lab\n      SFT, PPO, DPO, GRPO training loops in PyTorch on SmolLM2\n\n  04  ShopGraph\n      AI product discovery with collaborative filtering + market basket analysis\n\n  05  AeroSense\n      IoT air-quality ML with Flask, Scikit-learn, Matplotlib, AWS",
